...
function ProductItemDetail({ product }) {
  ...
  const addToCart = () => {
    ...
    GlobalApi.addToCart(data, jwt).then(
      (resp) => {
        console.log(resp), toast("Added to Cart");
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 p-7 bg-white text-black shadow-lg rounded-lg">
      <Image
        src={
      ...
      <div className="flex flex-col gap-3 p-5">
        ...
        <div className="flex flex-col items-baseline gap-3">
          <div className="flex gap-3 items-center">
            <div className="p-2 border flex gap-10 items-center px-5 rounded-md">
              <button
          ...
          <Button
            className="flex gap-3 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
            onClick={addToCart}
            disabled={loading}
          >
            <ShoppingBasket />
